...
urlpatterns = [
    ...
    path('distributor/info/', views.distributor_info),
    ...
    # path('distributor-list-dealer/', views.distributor_list_dealer, name='distributor_list_dealer'),
    
    # path('approveby-distributor/', views.approveby_distributor, name='approveby_distributor'),
    # path('dealer-list-distributor/', views.dealer_list_distributor, name='dealer_list_distributor'),

    # path('json-pass-inquary/',views.json_pass_inquary,name="json_pass_inquary"),
]
