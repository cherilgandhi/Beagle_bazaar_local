...
class AddressForm(base.BaseModelForm):
    half = ['tel_number', 'pin_code', 'effective_year', 'effective_month', 'state', 'city','country']
    ...
    country = forms.ChoiceField(choices=enums.countries, required=True,
                              label="Country <small class=asterisk>*</small>",
                              widget=forms.Select(attrs={'title': 'Country Detail...!'}))
    ...
    state = forms.CharField(required=True,
                              ...
                              widget=forms.TextInput(attrs={'title': 'State Detail...!'}))
