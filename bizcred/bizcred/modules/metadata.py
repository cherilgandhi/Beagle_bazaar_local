...
def isset_bit(arr, x):
    ...
    # print(z)
    '''
        it return the twice of the recent value 2,4,8,16,32,etc x times
        means formmap = 11 then it send 11 times.
    '''
    return (arr & (1 << x)) > 0
...
class Metadata(models.Model):
    ...
    def is_complete(self, step):
        # print(isset_bit(self.completion, step))
        '''sended the completation field value and step 
            to isset_bit function created above'''
        # print('completion level - > ',self.completion)
