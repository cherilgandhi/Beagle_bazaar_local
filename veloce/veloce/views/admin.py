            ...
            if review_app.is_approved:
                ...
                if get_bill_info:
                    if get_bill_info.dealers_given_finance_scheme:
                        ...
                        disbursement_amount=float(sanctioned_loan_amount) * float(d_interest_rate) * pow(1+float(d_interest_rate),d_tenure)/(pow(1+float(d_interest_rate),d_tenure)-1)
