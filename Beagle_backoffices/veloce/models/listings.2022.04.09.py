...
class UserCart(models.Model):
    ...
    check_disc = models.SmallIntegerField(choices=enums.to_choices(enums.CheckCartDiscountType), default=0)
    created_at = models.DateTimeField(auto_now_add=True)
    
    
class Checkout(models.Model):
    user = models.ForeignKey(AuthUser,on_delete=models.CASCADE)
    user_cart = models.ManyToManyField(UserCart)
    ...
    phone_number = models.CharField(max_length=17,null=False,
                                    default='',
                                    # help_text="format: '+91 123-456-7980'. Up to 15 digits is allowed.",
                                    verbose_name='Phone Number <small class="asterisk">*</small>',)
    email = models.EmailField(max_length=55,verbose_name='Email <small class="asterisk">*</small>')
    country = models.CharField(choices=enums.countries,max_length = 2,default= 'IN',verbose_name='Country <small class="asterisk">*</small>')
    address_type = models.SmallIntegerField(choices=enums.to_choices(enums.CheckoutAddressType),default=1,verbose_name='Address Type <small class="asterisk">*</small>')
