    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='bizcred.AuthUser')),
            ],
        ),
        migrations.CreateModel(
            name='VeloceScore',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reject_reason', models.TextField(blank=True, default='', null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bizcred.AuthUser')),
            ],
        ),
        migrations.CreateModel(
            name='Phone',
