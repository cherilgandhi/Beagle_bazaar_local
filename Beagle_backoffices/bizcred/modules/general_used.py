...
# from backoffice_bizcred.forms import base
# from backoffice_bizcred.modules.base import Module
...
class GeneralForm(base.BaseModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.user is not None:
            try:
                org = company_details.CompanyDetails.objects.get(user=self.user)
            except:
                org = None
