...
urlpatterns = [
    ...
    # common profile view for all users.
    ...
    # notes :- product orders is listed here
    path('all-orders',views.all_orders,name="all_orders"),
    path('order-view/<int:pk>/',views.orders_view,name='orders_view'),
    path('ajax-email-by-order_status',views.ajax_email_by_order_status,name="ajax_email_by_order_status"),
    path('ajax-order_id-by-email',views.ajax_order_id_by_email,name="ajax_order_id_by_email"),
    path('ajax-order_date-by-order_id',views.ajax_order_date_by_order_id,name="ajax_order_date_by_order_id"),
    ...
    path('check-email-exist/',views.check_email_exist,name="check_email_exist"),
    ...
    path('ajax-user-permissions/',views.ajax_user_permission,name = 'ajax_user_permission'),
